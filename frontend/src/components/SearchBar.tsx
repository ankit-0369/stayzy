...
const SearchBar = () => {
    ...
    return (
        ...
        >
            ...
            <div className="flex flex-col md:flex-row justify-center items-center bg-white px-2 py-1 gap-2">
                ...
                <label className="items-center flex">
                    Children:
                    <input
                        className="w-full p-1 focus:outline-none font-bold text-black"
                        type="number"
                        min={0}
                        max={20}
                        value={childCount}
            ...
            <div className="border border-solid border-green-400">
                <DatePicker
                    selected={checkIn}
